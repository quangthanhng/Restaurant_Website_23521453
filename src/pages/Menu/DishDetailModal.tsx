            ...
            >
                ...
                <div className='p-8'>
                    ...
                    <div className='mb-8 flex items-center gap-4 rounded-xl border border-neutral-800 bg-neutral-950/50 p-6'>
                        ...
                        <button className='flex items-center gap-3 rounded-xl bg-savoria-gold px-8 py-4 font-semibold text-neutral-900 shadow-lg transition-all hover:scale-105 hover:shadow-xl hover:shadow-savoria-gold/30'>
