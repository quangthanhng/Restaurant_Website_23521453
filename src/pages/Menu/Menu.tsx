      ...
      <section className='relative h-[400px] w-full overflow-hidden bg-linear-to-b from-neutral-900 to-neutral-950'>
        ...
        <div className='relative flex h-full flex-col items-center justify-center px-6 text-center'>
          <div className='mb-4 inline-flex items-center gap-2 rounded-full border border-savoria-gold/30 bg-savoria-gold/10 px-6 py-2 backdrop-blur-sm'>
            ...
            <span className='text-sm font-medium text-savoria-gold'>Our Menu</span>
          </div>
          <h1 className='mb-4 font-serif text-5xl font-bold text-white md:text-6xl lg:text-7xl'>
            Discover Our
            <span className='block text-savoria-gold'>Culinary Delights</span>
          </h1>
          <p className='max-w-2xl text-lg text-neutral-300'>
            Explore our carefully curated selection of exquisite dishes, crafted with passion and the finest ingredients
          </p>
        </div>
      </section>
            ...
            <div className='sticky top-24'>
              ...
              <div className='mb-6'>
                <div className='relative'>
                  ...
                  <input
                    ...
                    className='w-full rounded-lg border border-neutral-700 bg-neutral-900/50 py-2.5 pl-10 pr-4 text-sm text-white placeholder:text-neutral-500 transition-all duration-300 focus:border-savoria-gold focus:outline-none focus:ring-2 focus:ring-savoria-gold/20'
                  />
                </div>
                {searchTerm && (
                  <button
                    onClick={() => setSearchTerm('')}
                    className='mt-2 text-xs text-neutral-400 hover:text-savoria-gold'
                  >
                    Clear search
                  </button>
                )}
              ...
              <div className='rounded-xl border border-neutral-800 bg-neutral-900/50 overflow-hidden'>
                ...
                <button
                  ...
                  className='flex w-full items-center justify-between p-4 transition-all hover:bg-neutral-800/50'
                >
                  <h3 className='text-sm font-semibold uppercase tracking-wider text-savoria-gold'>
                    Categories
                  </h3>
                  <svg
                    className={`h-5 w-5 text-savoria-gold transition-transform duration-300 ${isCategoriesOpen ? 'rotate-180' : ''
                      }`}
                    fill='none'
                    stroke='currentColor'
                    viewBox='0 0 24 24'
          ...
          <main className='flex-1'>
            ...
            {isLoading && (
              <div className='flex min-h-[400px] items-center justify-center'>
                <div className='flex flex-col items-center gap-4'>
                  ...
                  <p className='text-neutral-400'>Loading delicious dishes...</p>
                </div>
              </div>
            )}
            ...
            {!isLoading && filteredDishes.length === 0 && (
              <div className='flex min-h-[400px] flex-col items-center justify-center rounded-2xl border border-neutral-800 bg-neutral-900/50 p-12'>
                <svg className='mb-4 h-20 w-20 text-neutral-600' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
                  <path strokeLinecap='round' strokeLinejoin='round' strokeWidth='1.5' d='M9.172 16.172a4 4 0 015.656 0M9 10h.01M15 10h.01M12 20a8 8 0 100-16 8 8 0 000 16z' />
                </svg>
                <h3 className='mb-2 text-xl font-semibold text-neutral-300'>No dishes found</h3>
                <p className='text-neutral-500'>
                  {searchTerm ? `No results for "${searchTerm}" in this category` : 'No dishes available in this category'}
                </p>
              </div>
            )}
              ...
              <div className='grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3'>
                {filteredDishes.map((dish) => (
                  <div
                    ...
                    className='group relative cursor-pointer overflow-hidden rounded-2xl border border-neutral-800 bg-neutral-900/50 transition-all duration-300 hover:border-savoria-gold hover:shadow-2xl hover:shadow-savoria-gold/10'
                  >
                    {/* Image */}
                    ...
                    <div className='p-6'>
                      {/* Title */}
                      <h3 className='mb-2 font-serif text-xl font-bold text-white transition-colors group-hover:text-savoria-gold'>
                        {dish.name}
                      </h3>
