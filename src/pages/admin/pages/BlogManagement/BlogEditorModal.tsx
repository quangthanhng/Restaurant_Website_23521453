    ...
    <div className='fixed inset-0 z-50 flex items-center justify-center bg-black/60 overflow-y-auto'>
      <div className='w-full flex items-center justify-center min-h-screen py-8'>
        ...
        >
          ...
          <h3 className='mb-6 text-2xl font-serif font-bold text-amber-600 tracking-logo text-center drop-shadow'>
            {initialTitle ? 'Sửa bài viết' : 'Thêm bài viết'}
          </h3>
            ...
            <div className='flex-1'>
              ...
              {initialImage && !image && (
                <img
                  src={initialImage}
                  alt='Ảnh đại diện'
                  className='mt-2 max-h-24 rounded-lg border border-stone-200'
                />
              )}
              {image && <span className='block mt-2 text-green-400 text-xs'>Đã chọn: {image.name}</span>}
            </div>
          </div>
            ...
            <div className='flex-1 min-h-[300px] max-h-[400px] overflow-y-auto'>
              <Editor
                ...
                init={{
                  ...
                  content_style:
                    'body { font-family:Inter,sans-serif; font-size:16px; background: #18181b; color: #f3f3f3; }',
                  skin: 'oxide-dark',
                  content_css: 'dark',
                  branding: false
                }}
