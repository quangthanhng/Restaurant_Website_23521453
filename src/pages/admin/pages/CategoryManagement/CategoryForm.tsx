...
const CategoryForm: React.FC<CategoryFormProps> = ({
  ...
  return (
    <form
      ...
      onSubmit={onSubmit}
    >
      <h3 className='mb-4 sm:mb-6 text-lg sm:text-2xl font-serif font-bold text-amber-600 tracking-logo text-center drop-shadow'>
      ...
      <div className='mb-4 sm:mb-6'>
        ...
        {editCategory && editCategory.images && (
          <img
            ...
            alt='preview'
            className='w-16 h-16 sm:w-20 sm:h-20 mt-3 object-cover rounded-lg border border-gray-200 shadow'
          />
        )}
      </div>
